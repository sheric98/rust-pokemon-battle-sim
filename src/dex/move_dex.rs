...
use crate::core::{pokemon::stat_enum::StatEnum, pokemove::{move_category::MoveCategory, move_name::MoveName, pokemove::PokeMove, secondary_effect::SecondaryEffect}, poketype::poketype::PokeType, status::status::Status};

static MOVES_DB: LazyLock<EnumMap<MoveName, PokeMove>> = LazyLock::new(|| enum_map! {
    MoveName::Bite =>
        PokeMove::builder()
            .name(MoveName::Bite)
